...
const youtube = new YouTube("AIzaSyANhsYqwuYlwb4BXcIzQi1N6HUcP4SJ3r8");
const queue = new Map();
...
client.on("message", async message => {
	if (message.author.client) return; // bot  tidak akan menjawab jika command dikirim oleh bot lain
